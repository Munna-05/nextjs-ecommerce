...
const ProductCard = (props) => {
    ...
    return (
        <Link href={`/productdetails/${props.id}`}>
            <motion.div
                initial={{ y: 1000 }} animate={{ y: 1, transition: { delay: props.time / 9, type: 'tween' } }}

                className="w-full cursor-pointer bg-stone-50 hover:bg-stone-100">
                <img className="h-80 w-full object-scale-down p-2 mix-blend-multiply " width={100} height={200} src={props.image} alt="" />
